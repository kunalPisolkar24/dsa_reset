...
public:
    void run() {
        vector<TestCase> cases = {
            ...
            { {0, 1, 0, 2, 0}, {1, 2, 0, 0, 0} },
            { {-1, 0, 1}, {-1, 1, 0} },
            { {100, 0, 50, 0, 25}, {100, 50, 25, 0, 0} },
            { {0}, {0} },
            { {42}, {42} },
            { {0, 0, -5, -4, 0}, {-5, -4, 0, 0, 0} },
            { {}, {} },
            { {10, -10, 0, 0, 20}, {10, -10, 20, 0, 0} },
            { {5, 0}, {5, 0} },
            { {0, 5}, {5, 0} },
            { {0, 0, 0, 7, 8, 9, 0}, {7, 8, 9, 0, 0, 0, 0} }
        };
        ...
        cout << Color::BOLD << "Running " << totalCount << " Tests for Move All Zeros to End..." << Color::RESET << "\n\n";
        ...
        for (int i = 0; i < totalCount; i++) {
            ...
            vector<int> result = sol.moveZeros(tc.arr);
