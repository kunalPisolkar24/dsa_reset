...
public:
    void run() {
        vector<TestCase> cases = {
            ...
            { {0, 0, 0, 0}, 0, {} },
            { {1, 2, 1, 2, 1}, 1, {2, 2} },
            { {7, 8, 9, 10, 11}, 8, {7, 9, 10, 11} },
            { {100}, 100, {} },
            { {100}, 50, {100} },
            { {1, 2, 3, 4, 5, 5, 4, 3, 2, 1}, 5, {1, 2, 3, 4, 4, 3, 2, 1} },
            { {-5, 4, -3, 2, -5}, -5, {4, -3, 2} },
            { {42, 42, 42}, 43, {42, 42, 42} },
            { {1, 3, 5, 7, 9}, 1, {3, 5, 7, 9} },
        ...
        cout << Color::BOLD << "Running " << totalCount << " Tests for Remove All Occurrences of X from Array..." << Color::RESET << "\n\n";
        ...
        for (int i = 0; i < totalCount; i++) {
            ...
            vector<int> result = sol.removeX(tc.arr, tc.x);
