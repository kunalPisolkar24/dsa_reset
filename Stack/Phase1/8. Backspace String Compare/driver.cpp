...
public:
    void run() {
        ...
        cout << Color::BOLD << "Running " << totalCount << " Tests for Backspace String Compare..." << Color::RESET << "\n\n";
        ...
        for (int i = 0; i < totalCount; i++) {
            ...
            bool result = sol.backspaceCompare(tc.s, tc.t);
            ...
            if (passed) {
                ...
                cout << "     " << Color::RED << "Input: s=\"" << tc.s << "\", t=\"" << tc.t << "\"" << Color::RESET << "\n";
