...
public:
    void run() {
        ...
        cout << Color::BOLD << "Running " << totalCount
             << " Tests for Climbing Stairs with Mandatory Stop..." << Color::RESET << "\n\n";
        ...
        for (int i = 0; i < totalCount; i++) {
            ...
            int result = sol.climbStairsWithMandatoryStop(tc.n, tc.m);
            ...
            if (passed) {
                ...
                cout << "     " << Color::YELLOW << "Input: " << Color::RESET << "n=" << tc.n << ", m=" << tc.m << "\n";
