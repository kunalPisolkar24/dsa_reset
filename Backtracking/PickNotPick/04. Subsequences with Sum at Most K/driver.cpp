...
public:
    void run() {
        vector<TestCase> cases = {
            ...
            { {2,4,6},   5,  {{2},{4}} },
            { {1,2,3},   0,  {} },
            { {1,2,3},   6,  {{1},{2},{3},{1,2},{1,3},{2,3},{1,2,3}} },
            { {3,5,7},   5,  {{3},{5}} },
            { {1},       1,  {{1}} },
            { {1},       0,  {} },
            { {1},       2,  {{1}} },
            ...
            { {1,2},     1,  {{1}} },
            { {5,1,3},   4,  {{1},{3},{1,3}} },
            { {10,20,5}, 15, {{10},{5},{10,5}} },
            { {2,3,4},   10, {{2},{3},{4},{2,3},{2,4},{3,4},{2,3,4}} },
            { {1,2,3,4}, 4,  {{1},{2},{3},{4},{1,2},{1,3}} },
        };
        ...
        cout << Color::BOLD << "Running " << totalCount
             << " Tests for Subsequences with Sum at Most K..." << Color::RESET << "\n\n";
        ...
        for (int i = 0; i < totalCount; i++) {
            ...
            vector<vector<int>> result = sol.subsequencesWithSumAtMostK(tc.arr, tc.target);
