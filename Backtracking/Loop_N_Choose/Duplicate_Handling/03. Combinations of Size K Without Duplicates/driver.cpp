...
public:
    void run() {
        vector<TestCase> cases = {
            { {1,1,2,2,3}, 2, {{1,1}, {1,2}, {1,3}, {2,2}, {2,3}} },
            { {1,2,3},   2, {{1,2}, {1,3}, {2,3}} },
            { {1,1,1},   2, {{1,1}} },
            { {1,2},     3, {} },
            { {1,1},     1, {{1}} },
        ...
        cout << Color::BOLD << "Running " << totalCount
             << " Tests for Combinations of Size K Without Duplicates..." << Color::RESET << "\n\n";
        ...
        for (int i = 0; i < totalCount; i++) {
            ...
            vector<vector<int>> result = sol.combineUnique(tc.nums, tc.k);
