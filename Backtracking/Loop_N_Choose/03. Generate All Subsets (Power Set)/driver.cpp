...
public:
    void run() {
        vector<TestCase> cases = {
            ...
            { {0},       {{}, {0}} },
            { {0,1},     {{}, {0}, {1}, {0,1}} },
            { {10,20,30},{{}, {10}, {20}, {30}, {10,20}, {10,30}, {20,30}, {10,20,30}} },
            { {1},       {{}, {1}} },
        ...
        cout << Color::BOLD << "Running " << totalCount
             << " Tests for Generate All Subsets..." << Color::RESET << "\n\n";
        ...
        for (int i = 0; i < totalCount; i++) {
            ...
            vector<vector<int>> result = sol.subsets(tc.arr);
            ...
            // For subsets, both the order of subsets and the contents within subsets matter.
            // But the contents are already relative order preserved.
            // We just need to sort the outer vector for comparison.
