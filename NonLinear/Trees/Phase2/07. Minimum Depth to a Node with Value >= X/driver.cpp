...
public:
  void run() {
    vector<TestCase> cases = {
        ...
        {{1, 2, 3}, 2, 2},
        {{1, 2, 3}, 4, -1},
        {{5, 3, 10, 1, NULL_NODE, 7}, 7, 2},
        {{5, 3, 10, 1, NULL_NODE, 7}, 4, 1},
        {{4, 2, 6, 1, 3, 5, 7}, 6, 2},
        {{4, 2, 6, 1, 3, 5, 7}, 8, -1},
        {{3, 2, NULL_NODE, 1, NULL_NODE}, 2, 1},
        {{-1, -2, 3, -3, NULL_NODE, NULL_NODE, 4}, 2, 2},
        {{2, 1, 5, NULL_NODE, NULL_NODE, 3, 6}, 4, 2},
        {{10, 9, 8, 7, 6, 5, 4}, 6, 1},
        {{10, 9, 8, 7, 6, 5, 4}, 11, -1},
        {{1, 2, 3, 4, NULL_NODE, NULL_NODE, 5}, 5, 3},
        {{0, -1, 2}, -1, 1},
    };
    ...
    cout << Color::BOLD << "Running " << totalCount
         << " Tests for Minimum Depth to a Node with Value >= X..."
         << Color::RESET << "\n\n";
    ...
    for (int i = 0; i < totalCount; i++) {
      ...
      int result = sol.minDepthToValueAtLeast(root, tc.x);
      ...
      if (passed) {
        ...
        cout << "]" << Color::RESET << "\n";
        cout << "     " << Color::RED << "X: " << tc.x << Color::RESET << "\n";
