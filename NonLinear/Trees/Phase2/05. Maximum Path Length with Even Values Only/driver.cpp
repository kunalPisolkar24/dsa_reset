...
public:
    void run() {
        vector<TestCase> cases = {
            { {2, 4, 6, 3, -100000, -100000, 8}, 3 },
            { {1, 2, 4}, 0 },
            { {2, 2, 2, 2, 2, 2, 2}, 3 },
            { {4, 6, 8, 10, 12, 14, 16}, 3 },
            { {10, 2, 2, 2, 2, 2, 3}, 3 },
            { {2, -100000, 4, -100000, 6, -100000, 8}, 4 },
            { {6, 2, 2, -100000, 2, 2, -100000}, 3 },
            { {2, 4, 1, 2, 2, -100000, -100000}, 3 },
            { {0, 0, 0, 0, 0}, 3 },
            { {8, 6, 4, 1, -100000, -100000, 2}, 3 },
            { {2, 2, 2, 1}, 2 },
            { {10, 20, 30, -100000, 40}, 3 },
            { {2, 2}, 2 },
            { {2, 4, 6, 1, 2, 4, 6}, 3 },
            { {10, 1, 20}, 2 },
            { {2, 4, 1, 2, 3}, 3 }
        ...
        cout << Color::BOLD << "Running " << totalCount << " Tests for Maximum Path Length with Even Values Only..." << Color::RESET << "\n\n";
        ...
        for (int i = 0; i < totalCount; i++) {
            ...
            auto result = sol.maxEvenPathLength(root);
