...
public:
    void run() {
        vector<TestCase> cases = {
            ...
            { {-10, 9, 20, -100000, -100000, 15, 7}, 2 },
            { {5, 4, 8, 11, -100000, 13, 4, 7, 2, -100000, -100000, -100000, 1}, 3 },
            { {1, -100000, 2, -100000, 3, -100000, 4}, 4 },
            { {1, 2, 3, 4, -100000, -100000, 5}, 3 },
            { {10, 5, 15, 3, 7, 12, 18}, 3 },
            { {1, 2, 2, 3, 4, 4, 3}, 3 },
            { {1, 2, 2, -100000, 3, -100000, 3}, 3 },
            { {3, 9, 20, -100000, -100000, 15, 7}, 2 },
            { {-10, -20, -30}, 2 }
        };
        ...
        cout << Color::BOLD << "Running " << totalCount << " Tests for Minimum Depth of Binary Tree..." << Color::RESET << "\n\n";
