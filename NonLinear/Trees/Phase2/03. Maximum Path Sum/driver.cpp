...
public:
    void run() {
        vector<TestCase> cases = {
            ...
            { {-10, 9, 20, -100000, -100000, 15, 7}, 42 },
            { {5, 4, 8, 11, -100000, 13, 4, 7, 2, -100000, -100000, -100000, 1}, 48 },
            { {1, -100000, 2, -100000, 3, -100000, 4}, 10 },
            { {1, 2, 3, 4, -100000, -100000, 5}, 15 },
            { {10, 5, 15, 3, 7, 12, 18}, 55 },
            { {1, 2, 2, 3, 4, 4, 3}, 13 },
            { {1, 2, 2, -100000, 3, -100000, 3}, 11 },
            { {3, 9, 20, -100000, -100000, 15, 7}, 47 },
            { {-10, -20, -30}, -10 }
        };
        ...
        cout << Color::BOLD << "Running " << totalCount << " Tests for Maximum Path Sum (Any Node to Any Node)..." << Color::RESET << "\n\n";
        ...
        for (int i = 0; i < totalCount; i++) {
            ...
            auto result = sol.maxPathSum(root);
