...
public:
    void run() {
        vector<TestCase> cases = {
            ...
            { {1, 2, 3, 4, -100000, -100000, 5}, 9 },
            { {10, 5, 15, 3, 7, 12, 18}, 43 },
            { {1, 2, 2, 3, 4, 4, 3}, 7 },
            { {1, 2, 2, -100000, 3, -100000, 3}, 6 },
            { {3, 9, 20, -100000, -100000, 15, 7}, 38 },
            { {-10, -20, -30}, -30 }
        };
        ...
        cout << Color::BOLD << "Running " << totalCount << " Tests for Maximum Root-to-Leaf Sum..." << Color::RESET << "\n\n";
        ...
        for (int i = 0; i < totalCount; i++) {
            ...
            auto result = sol.maxRootToLeafSum(root);
