...
public:
    void run() {
        vector<TestCase> cases = {
            ...
            { {1, -100000, 2, 3}, false },
            { {5, 4, 8, 11, -100000, 13, 4, 7, 2, -100000, -100000, 5, 1}, false }
        };
        ...
        cout << Color::BOLD << "Running " << totalCount << " Tests for Mirror Tree Check (Basic)..." << Color::RESET << "\n\n";
