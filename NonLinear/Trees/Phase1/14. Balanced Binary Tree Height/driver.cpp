...
public:
    void run() {
        ...
        cout << Color::BOLD << "Running " << totalCount << " Tests for 14. Return -1 if Imbalance Found..." << Color::RESET << "\n\n";
        ...
        for (int i = 0; i < totalCount; i++) {
            ...
            auto result = sol.checkHeight(root);
